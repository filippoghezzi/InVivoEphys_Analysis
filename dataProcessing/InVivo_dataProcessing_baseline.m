...
%         s -> structure of spike data;
    ...
    LFP = loadLFP(ops.fbinary,startBaseline,ops.fs,ops.NchanTOT,[0 endBaseline]/ops.fs);  
    ...
    results.spectral = InVivo_dataProcessing_baseline_powerSpectrum(ops,s,'LFP',LFP(ops.L4best,:),'endBaseline',endBaseline,'Plotting',1);
